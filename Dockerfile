...
COPY docker/php-extensions/php84.list /tmp/php-extensions.list

RUN set -eux; \
    apt-get update; \
    apt-get install -y --no-install-recommends gettext-base libcap2-bin unzip p7zip-full; \
